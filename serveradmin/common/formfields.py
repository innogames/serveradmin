...
ipv4cidr_re = re.compile(
    '^((2[0-5]{2}|2[0-4]\d|1\d{2}|[1-9]\d|\d)\.){3}'
    '(2[0-5]{2}|2[0-4]\d|1\d{2}|[1-9]\d|\d)/(3[012]|[12]\d|\d)$'
)
validate_ipv4_cidr = RegexValidator(
    ipv4cidr_re, 'Enter a valid IPv4 CIDR', 'invalid'
)
