    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'attribute',
                    models.ForeignKey(
                        limit_choices_to={'multi': False, 'readonly': True, 'type': 'number'},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'collection',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='graphite.Collection'),
                ),
            ],
            options={
