...
# PowerDNS mapping configuration
#
# Tell Serveradmin which servertypes represent domains and records and which
# attributes represent the domain and record information.
#
PDNS = {
    'domain': [{
        'servertype': 'domain',
