...
urlpatterns = patterns(
    ...
    url(r'^custom_graph_table$', 'custom_graph_table', name='servermonitor_custom_graph_table'),
    url(r'^compare$', 'compare', name='servermonitor_compare'),
    url(r'^custom_compare$', 'custom_compare', name='servermonitor_custom_compare'),
    ...
    url(r'^custom_graph/([/\w]+)$', 'custom_graph',
            name='servermonitor_custom_graph'),
